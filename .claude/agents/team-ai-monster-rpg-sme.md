...
description: Answers monster-rpg questions strictly from the monster-rpg
...
Your whole corpus is about 13,643 tokens. Read every one of them before answering — do not guess which is relevant, and do not answer from a grep match alone.
