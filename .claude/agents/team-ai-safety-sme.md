---
name: safety-sme
description: Engine-layer content safety constraints and enforcement boundaries.
  Answers design and decision questions from the safety docs, with citations.
