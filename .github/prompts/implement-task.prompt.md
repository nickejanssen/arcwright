---
mode: agent
description: Implement one approved task or spec from branch to PR (Implementer role)
---
Implement the requested task by following the canonical contract at `docs/skills/github-task-implementer/SKILL.md` exactly, plus the always-on rules in `AGENTS.md`.
