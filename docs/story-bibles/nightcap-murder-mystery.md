...
The original file has moved to:

`docs/archive/nightcap-story-bibles/nightcap-murder-mystery.md`

**Do not use this file as current Nightcap design authority.**

Current Nightcap source of truth:

1. `docs/gdd/nightcap/00-governance/00-decision-ledger.md`
2. `docs/gdd/nightcap/00-governance/01-master-gdd-index.md`
3. `docs/gdd/nightcap/00-governance/02-current-design-state.md`
