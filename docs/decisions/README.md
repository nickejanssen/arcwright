...
- `0018-mini-game-orchestration-and-execution-adapters.md` - proposed adapter-aware mini-game orchestration boundary for Arcwright-hosted and external host-authoritative games; supersedes ADR 0009 if accepted
