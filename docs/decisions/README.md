...
- `0019-minigame-readiness-execution-gated-on-ownership-reconciliation.md` - D-100 holds all mini-game readiness execution at the merged browser golden path until three conflicting records agree on who owns the remaining AW-285 scope and the AW-286 mutual dependency is broken; the owner itself is an open founder call
